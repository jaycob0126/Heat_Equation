...
float leftEndTemp = 60;      //degC
float rightEndTemp = 20;   //degC
float rodLength = 100;      //mm
boolean fixRightEnd = false; //true if rightEnd temperature is fixed
float div = 0.2;

float delT = 0.001;
float delX = 0.4;
float thDiffusivity = 11.1;
...
void displayData() {
  ...
  text("Thermal Diffusivity : " + thDiffusivity + "mm/s ", 330, 30);
